...
// ---------- SERVICE ACCOUNT ----------
// ลำดับการโหลด:
// 1) ถ้ามี GOOGLE_SERVICE_ACCOUNT_JSON (เช่นบน Render) → ใช้อันนี้
// 2) ถ้าไม่มี → ลองโหลดไฟล์ service-account.json (ใช้ตอน dev ในเครื่อง)
...
if (process.env.GOOGLE_SERVICE_ACCOUNT_JSON) {
  ...
  try {
    // dev ในเครื่อง: ต้องมีไฟล์ service-account.json ในโฟลเดอร์เดียวกับ index.js
    // และควรใส่ชื่อไฟล์นี้ใน .gitignore ห้าม commit ขึ้น Git
